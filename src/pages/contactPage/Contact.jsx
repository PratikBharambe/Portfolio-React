...
import { MdAddCall, MdContactMail } from "react-icons/md";
  ...
  return (
    <>
      ...
      <div className="px-6">
        ...
        <div className="flex flex-col sm:flex-row my-4 py-6 items-center space-y-4 sm:space-y-0 sm:space-x-6">
          {/* Call Section */}
          <div className="w-full sm:w-1/2 bg-[#131313] bg-opacity-75 rounded-lg border border-white p-8 text-center text-white space-y-4 shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
