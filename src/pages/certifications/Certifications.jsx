        ...
        <>
                ...
                {certifications.map((item, index) => (
                    <div key={index} className="rounded-lg overflow-hidden hover:shadow-2xl transition duration-300">
                        <div className="relative cursor-pointer" onClick={() => openModal(item)}>
                            <img className="w-full h-[250px] sm:h-[300px] object-cover" src={item.url} alt={item.title} />
                        </div>
            ...
            {selectedImage && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="p-6 rounded-lg w-4/5 sm:w-3/4 md:w-1/2 lg:w-1/3">
                        <div className="relative">
                            ...
                            {/* Image is now scaled to fit better on all screens */}
                            <img
